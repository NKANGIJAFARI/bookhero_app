export const Fonts = {
  ...
  white24Bold: { fontFamily: 'NotoSans_Bold', fontSize: 24.0, color: 'white' },
  ...
  primaryColorBold: { fontFamily: 'NotoSans_Bold', color: '#00ae3b' },

  secondaryColor16Regular: {
    fontFamily: 'NotoSans_Regular',
    color: 'red',
    fontSize: 16.0,
  },
...
// Previous primary color: #6979F8
export const Colors = {
  primary: '#00ae3b',
  primaryLight: '#6ad380',
  primaryLight2: '#79db9b',
  secondary: '#ff000f',
  lightGray: '#DBDBDB',
  darkGray: '#a4a4a4',
};
